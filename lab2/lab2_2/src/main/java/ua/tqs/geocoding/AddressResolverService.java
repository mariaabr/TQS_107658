package ua.tqs.geocoding;

import ua.tqs.connection.ISimpleHttpClient;
...
public class AddressResolverService {
    ...
    public Optional<Address> findAddressForLocation(double latitude, double longitude) throws URISyntaxException, IOException, ParseException, org.json.simple.parser.ParseException {
        ...
        if (latitude < -90 || latitude > 90 || longitude < -180 || longitude > 180) { // without this validation the findAddressForLocation return null and gives an error (NullPointer)
